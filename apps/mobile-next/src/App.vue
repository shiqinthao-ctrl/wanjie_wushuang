...
<template>
  <BattleView v-if="page === 'battle' && active" :save="active.save" @exit="home" />
  <main v-else class="app-shell">
    ...
    <section v-if="page === 'home'" class="lobby">
      ...
      <div class="expedition"><span class="eyebrow">下一站 · ST001-01</span><h2>边境清剿</h2><p>在 06:00 前击败黄巾巨将并领取战利品。</p>
        ...
        <button ref="startButton" :disabled="!active || busy || !!storageError || !!launchBlocker" class="primary embark" @click="enter">进入战场预览 <span aria-hidden="true">→</span></button><p class="release-note">移动版建设中，可体验战斗、升级与地图互动；首领和结算尚未接入。</p>
      </div>
    </section>
