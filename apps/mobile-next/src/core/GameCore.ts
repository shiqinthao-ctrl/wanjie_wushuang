...
export interface UiSnapshot { readonly status: RunStatus; readonly time: number }
...
export class GameCore {
  ...
  private player = { x: 1800, y: 1200, speed: 240 };
  ...
  snapshot(): UiSnapshot { return Object.freeze({ status: this.status, time: this.time }); }
  renderState() {
