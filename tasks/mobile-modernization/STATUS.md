...
| P2 first stage | P2a-f combat/growth/map/hazards/recovery and isolated save foundation implemented; events/Boss/settlement pending | Legacy 5 gates, 49 hashes, strict build and 775 tests pass | All 30 Chrome paths pass; natural combat/map/save UI and separate synthetic storage fixtures; full stage pending | Pending |
